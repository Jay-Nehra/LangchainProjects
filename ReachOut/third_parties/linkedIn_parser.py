...
def linkedIn_scrap(profile_url: str, mock: bool = True) -> Dict:
    ...
    if mock:
        ...
        linkedIn_profile_gist_url = (
            "https://gist.github.com/Jay-Nehra/027f554fea2a018ac8840b93e56181c9"
        )
        try:
            response = requests.get(url=linkedIn_profile_gist_url, timeout=15)
